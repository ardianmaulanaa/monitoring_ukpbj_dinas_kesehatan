...
type RoleCreateModalButtonProps = {
  users: ExistingUser[];
};
...
const inputClass =
  "h-11 rounded-lg border border-slate-300 px-3 text-sm font-semibold text-slate-700 outline-none transition focus:border-[#08783f] focus:ring-4 focus:ring-emerald-100";
...
export default function RoleCreateModalButton({ users }: RoleCreateModalButtonProps) {
  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-10 items-center justify-center rounded-lg bg-[#08783f] px-4 text-sm font-black text-white shadow-sm transition hover:bg-[#076b39]"
      >
        + Buat Role
      </button>
      ...
      >
        <div className="space-y-5">
          <form onSubmit={saveRole} className="rounded-lg border border-slate-200 bg-white p-5">
            <div className="flex items-center gap-2">
              <KeyRound className="h-5 w-5 text-[#08783f]" />
              <h3 className="text-base font-black text-[#16227c]">Form Role Baru</h3>
            </div>

            <div className="mt-5 grid gap-4 md:grid-cols-2">
              <label className="grid gap-2">
                <span className="text-xs font-black uppercase text-slate-400">Nama Role</span>
                <input
                  value={name}
              ...
              <label className="grid gap-2">
                <span className="text-xs font-black uppercase text-slate-400">Kode Role</span>
                <input
                  value={manualCode}
              ...
              <label className="grid gap-2">
                <span className="text-xs font-black uppercase text-slate-400">Aktor</span>
                <input
                  value={actor}
            ...
            <label className="mt-4 grid gap-2">
              <span className="text-xs font-black uppercase text-slate-400">Scope Akses</span>
              <textarea
                value={accessScope}
            ...
            <div className="mt-5 grid gap-5 lg:grid-cols-2">
              <div>
                <p className="text-xs font-black uppercase text-slate-400">Akses Modul</p>
              ...
              <div>
                <p className="text-xs font-black uppercase text-slate-400">Grant Access</p>
                <div className="mt-3 grid gap-2 sm:grid-cols-2">
          ...
          <section className="grid gap-5 lg:grid-cols-2">
            <div className="rounded-lg border border-slate-200 bg-white p-5">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-black text-[#16227c]">Preview</h3>
              </div>
              <div className="mt-4 rounded-lg border border-slate-200 bg-slate-50 p-4">
                <span className="inline-flex rounded-full bg-[#08783f] px-3 py-1 text-xs font-black text-white">
                  {name || "Nama Role"}
                </span>
                <p className="mt-4 font-mono text-xs font-black text-slate-400">{code}</p>
            ...
            <div className="rounded-lg border border-slate-200 bg-white p-5">
              <div className="flex items-center justify-between gap-3">
                <h3 className="text-base font-black text-[#16227c]">Role Custom Demo</h3>
          ...
          <section className="rounded-lg border border-slate-200 bg-white p-5">
            <div className="flex flex-col gap-3 border-b border-slate-100 pb-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-black text-[#16227c]">User Terdaftar</h3>
              </div>
            ...
            <div className="max-h-[420px] divide-y divide-slate-100 overflow-y-auto">
              {users.length > 0 ? (
                ...
                <div className="p-8 text-center">
                  ...
                  <p className="mt-3 text-sm font-black text-slate-700">Belum ada user</p>
                </div>
              )}
            </div>
            <Link
