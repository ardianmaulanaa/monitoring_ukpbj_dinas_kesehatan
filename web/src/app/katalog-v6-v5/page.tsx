...
const pageConfigs = {
  ...
  paket: {
    ...
    rightLabel: "Paket",
    icon: ClipboardList,
    primaryAction: { label: "Tambah paket", href: "/paket-pengadaan/tambah" },
  },
  rup: {
    title: "SIRUP / RUP",
    subtitle:
  ...
  kontrak: {
    ...
    rightLabel: "Kontrak",
    icon: FileCheck2,
    primaryAction: { label: "Tambah kontrak", href: "/kontrak-sp/tambah" },
  },
  progres: {
    title: "Progres Fisik",
    subtitle:
    ...
    rightLabel: "Progres",
    icon: BarChart3,
    primaryAction: { label: "Tambah progres", href: "/progres-fisik/tambah" },
  },
  realisasi: {
  ...
  penyedia: {
    ...
    rightLabel: "Vendor",
    icon: Truck,
    primaryAction: { label: "Tambah penyedia", href: "/vendor-pasar/tambah" },
  },
  warning: {
...
function getTahapContent(tahap?: string) {
  if (tahap === "perencanaan") {
    return {
      ...
      actionHref: "/paket-pengadaan/tambah",
    };
  }
